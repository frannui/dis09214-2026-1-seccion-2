# sesión 11 - 18/06  
## Sonido en p5 loadSound()  

**Paso 1**: subir sonidos a p5  
...
**Paso 2**: declarar y precargar el sonido functionPreload()  
1. Creamos una variable global al inicio del código para guardar nuestro sonido.

2. Usamos la función functionPreload() inicializamos nuestra variable y cargamos el sonido con loadSound()

**Paso 3**: activar sonido  
